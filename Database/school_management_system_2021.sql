...
(3, 'Biology', 'Biology, study of living things and their vital processes. The field deals with all the physicochemical aspects of life. ... Cell biology is the study of cells—the fundamental units of structure and function in living organisms., a', 'Inactive', 'Senior Secondary School', 5, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', 'build wordpress ecommerce or business website responsive 2.png'),
(4, 'Physics', 'Physics encompasses the study of the universe from the largest galaxies to the smallest subatomic particles. Moreover, it's the basis of many other sciences, including chemistry, oceanography, seismology, and astronomy (and can be applied to biology or medical science).', 'Active', 'Senior Secondary School', 5, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', 'build wordpress ecommerce or business website responsive 2.png'),
(6, 'Chemistry', 'Chemistry is the study of matter and the chemical reactions between substances. Chemistry is also the study of matter’s composition, structure, and properties. Matter is essentially anything in the world that takes up space and has mass. Chemistry is sometimes called “the central science,” because it bridges physics with other natural sciences, such as geology and biology..\r\n\r\n', 'Active', '	\r\nSenior Secondary School', 3, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', '3cdd7db2149554995ca05e279fc78036.jpg'),
(7, 'Mathematics', ' Mathematics is the science and study of quality, structure, space, and change. Mathematicians seek out patterns, formulate new conjectures, and establish truth by rigorous deduction from appropriately chosen axioms and definitions..\r\n\r\n', 'Inactive', 'Senior Secondary School', 5, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', '3cdd7db2149554995ca05e279fc78036.jpg'),
(8, 'Basic Science', 'The basic sciences are defined as the scientific disciplines of mathematics, physics, chemistry, and biology. They are called basic sciences because they provide a fundamental understanding of natural phenomena and the processes by which natural resources are transformed..\r\n\r\n', 'Active', 'Junior Secondary School', 5, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', '3cdd7db2149554995ca05e279fc78036.jpg'),
(9, 'Agricultural Science', 'agricultural sciences, sciences dealing with food and fibre production and processing. They include the technologies of soil cultivation, crop cultivation and harvesting, animal production, and the processing of plant and animal products for human consumption and use. Food is the most basic human need..\r\n\r\n', 'Inactive', 'Junior Secondary School', 4, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', '3cdd7db2149554995ca05e279fc78036.jpg'),
(10, 'Music', 'Musicology literally means “the study of music” and includes the cultural and historical periods. Just as art history is the academic study of the history of art, music can also be studied at a similar level of academic depth..\r\n\r\n', 'Active', '	\r\nJunior Secondary School', 3, '2021-08-20', 'dsfsdf', 35325235, 'fsafsa@gmail.com', '3cdd7db2149554995ca05e279fc78036.jpg');
...
(3, 'Biology', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(4, 'Physics', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(5, 'English', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(6, 'Chemistry', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(7, 'Mathematics', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(8, 'Basic Science', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(9, 'Agricultural Science', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to '),
(10, 'Music', 'as well, but I am coming up short. There seem to be guides on copy/pasting scripts for the share buttons, as well as guides on using each respective API, but for something so simple as using links to ');
